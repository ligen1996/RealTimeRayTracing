...
def render_graph_STSMRenderGraph():
    ...
    FlatNormal = createPass('FlatNormal')
    g.addPass(FlatNormal, 'FlatNormal')
    ...
    g.addEdge('FlatNormal.FlatNormalW', 'STSM_ReuseFactorEstimation.Normal_RF')
    g.addEdge('FlatNormal.FlatNormalW', 'STSM_TemporalReuse.Normal')
    g.addEdge('FlatNormal.FlatNormalW', 'STSM_BilateralFilter.Normal')
