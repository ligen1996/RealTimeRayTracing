...
def render_graph_STSMRenderGraph():
    ...
    g.addEdge('STSM_BilateralFilter.Result', 'STSM_ReuseFactorEstimation.Color')
    g.addEdge('GBufferRaster.depth', 'STSM_ReuseFactorEstimation.Depth')
    g.addEdge('GBufferRaster.mvec', 'STSM_ReuseFactorEstimation.MotionVector')
    g.addEdge('STSM_ReuseFactorEstimation.MotionVector', 'STSM_TemporalReuse.Motion Vector')
