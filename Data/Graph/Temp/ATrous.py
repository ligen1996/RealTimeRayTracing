...
def render_graph_STSMRenderGraph():
    ...
    ATrousFilter = createPass('ATrousFilter')
    g.addPass(ATrousFilter, 'ATrousFilter')
    ...
    g.addEdge('GBufferRaster.linearZ', 'ATrousFilter.LinearZ')
    g.addEdge('GBufferRaster.normW', 'ATrousFilter.Normal')
    g.addEdge('STSM_TemporalReuse.TR_Visibility', 'ATrousFilter.Vis')
