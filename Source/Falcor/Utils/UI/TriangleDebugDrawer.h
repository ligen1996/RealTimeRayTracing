...
namespace Falcor
{
    ...
    */
    class dlldecl TriangleDebugDrawer //todo :
    {
    public:

        using SharedPtr = std::shared_ptr<TriangleDebugDrawer>;
        using SharedConstPtr = std::shared_ptr<const TriangleDebugDrawer>;
    ...
    private:
        ...
        TriangleDebugDrawer(uint32_t maxVertices);
